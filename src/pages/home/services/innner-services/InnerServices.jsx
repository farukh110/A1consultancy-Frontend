...
const InnerServices = () => {
    ...
    return (
        <>
            <div className="bg-screen">
                ...
                >
                    <g transform="">
                        ...
                        <circle cx={0} cy={0} r={0} fill="#014c86" fillOpacity="0.4">
                            <animateTransform
                                attributeName="transform"
                                type="scale"
                                repeatCount="indefinite"
            ...
            <div>
                <nav className="navbar navbar-light bg-header text-center">
                    <div className="col-md-12 col-sm-12 pt-4">
                        <a className="welcome-board-name" href="#">
                            Our Services
                        </a>
                    </div>
                </nav>
            ...
            <div className="container">
                <div className="row mt-lg-5 mt-md-4 justify-content-center">
                    <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mt-lg-0 mt-md-3 mt-4">
                        <a
                            href="!#"
                            target="_blank"
                        >
                                ...
                                <div className="content-front">
                                    <div className="cf-inner">
                                        <div
                                            ...
                                            style={{
                                                backgroundImage:
                                                    "url(https://images.unsplash.com/photo-1481487196290-c152efe083f5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=830&q=80)"
                                            }}
                                        />
                                        ...
                                        <div className="inner">
                                            <div className="dec-icon">
                                                <svg
                                                    ...
                                                    style={{ enableBackground: "new 0 0 487.16 487.16" }}
                                                    xmlSpace="preserve"
                                                    width="50%"
                                                    height="100%"
                                                    className=""
                            ...
                            <div className="content-front">
                                <div className="cf-inner">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(https://images.unsplash.com/photo-1463171379579-3fdfb86d6285?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80)"
                                        }}
                                    />
                                    <div className="overlay" />
                                    <div className="inner">
                                    ...
                                    <div className="inner">
                                        <div className="dec-icon">
                                            <svg
                                                ...
                                                style={{ enableBackground: "new 0 0 488.477 488.477" }}
                                                xmlSpace="preserve"
                                                width="50%"
                                                height="100%"
                                                className=""
                                            >
                                                <g>
                                                    <g>
                                                        ...
                                                        />
                                                        <path
                                                            d="M38.094,66.683c8.409,0,15.25-6.841,15.25-15.25c0-8.409-6.841-15.25-15.25-15.25s-15.25,6.841-15.25,15.25   C22.844,59.842,29.685,66.683,38.094,66.683z M38.094,44.683c3.722,0,6.75,3.028,6.75,6.75c0,3.722-3.028,6.75-6.75,6.75   c-3.722,0-6.75-3.028-6.75-6.75C31.344,47.711,34.372,44.683,38.094,44.683z"
                                                            data-original="#000000"
                                                            className="active-path"
                                                            data-old_color="#000000"
                                                            style={{ fill: "#05C2DE" }}
                                                        />
                                                        <path
                                                            d="M80.594,66.683c8.409,0,15.25-6.841,15.25-15.25c0-8.409-6.841-15.25-15.25-15.25s-15.25,6.841-15.25,15.25   C65.344,59.842,72.185,66.683,80.594,66.683z M80.594,44.683c3.722,0,6.75,3.028,6.75,6.75c0,3.722-3.028,6.75-6.75,6.75   c-3.722,0-6.75-3.028-6.75-6.75C73.844,47.711,76.872,44.683,80.594,44.683z"
                                                            data-original="#000000"
                                                            className="active-path"
                                                            data-old_color="#000000"
                                                            style={{ fill: "#05C2DE" }}
                                                        />
                                                        <path
                                                            d="M123.094,66.683c8.409,0,15.25-6.841,15.25-15.25c0-8.409-6.841-15.25-15.25-15.25s-15.25,6.841-15.25,15.25   C107.844,59.842,114.685,66.683,123.094,66.683z M123.094,44.683c3.722,0,6.75,3.028,6.75,6.75c0,3.722-3.028,6.75-6.75,6.75   c-3.722,0-6.75-3.028-6.75-6.75C116.344,47.711,119.372,44.683,123.094,44.683z"
                                                            data-original="#000000"
                                                            className="active-path"
                                                            data-old_color="#000000"
                                                            style={{ fill: "#05C2DE" }}
                            ...
                            <div className="content-front">
                                <div className="cf-inner">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=751&q=80)"
                                        }}
                                    />
                                    <div className="overlay" />
                                    <div className="inner">
                                            ...
                                            >
                                                <g>
                                                    <g>
                                                        ...
                                                        />
                                                        <path
                                                            d="M303.668,48.486h61.496c2.348,0,4.25-1.902,4.25-4.25c0-2.348-1.902-4.25-4.25-4.25h-61.496c-2.348,0-4.25,1.902-4.25,4.25   C299.418,46.584,301.32,48.486,303.668,48.486z"
                                                            data-original="#000000"
                                                            className="active-path"
                                                            data-old_color="#000000"
                                                            style={{ fill: "#05C2DE" }}
